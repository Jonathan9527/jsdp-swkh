<template>
  <div class="ProvincialAuthorities" id="line3hyg">
    <el-form class="issueTop">
      <div class="asstopWrap" style="margin-top:4px;">
        <el-form-item label="年份：" class="assessSelect">
          <el-select v-model="value" size="mini" placeholder="请选择" class="selectWrap" @change="search()" style="width:150px">
