<template>
  <div class="DividedDistricts" id="leaderbanzihyl" style="padding: 0 15px;">
    <el-form class="issueTop">
      ...
      <div class="unitList">
        <p><span>{{value}}</span>年度省直机关一类领导班子排名情况</p>
      </div>
    </el-form>
    <div>
      <div class="tableboxs">
        ...
        <el-table id="banzishuju" :data="assessmentScore" border style="width: 100%" stripe height="500">
          ...
          <el-table-column label="年度综合考核">
              <el-table-column prop="city_score" sortable label="得分" width="110"> </el-table-column>
              <el-table-column prop="city_lev" label="等次" width="110"> </el-table-column>
          </el-table-column>
          <el-table-column label="党政班子得票率">
            <el-table-column prop="pct_1" sortable label="好（%）" width="120">
            </el-table-column>
            <el-table-column prop="pct_2" label="较好（%）" width="110">
            </el-table-column>
            <el-table-column prop="pct_3" label="一般（%）" width="110">
            </el-table-column>
            <el-table-column prop="pct_4" label="较差（%）" width="110">
            </el-table-column>
            <el-table-column prop="pct_5" label="未填（%）" width="110">
            </el-table-column>
          </el-table-column>
          <el-table-column prop="lev" label="等次" width="120">
