<template>
  <div class="DividedDistricts" id="leaderganbuhyl" style="padding: 0 15px;">
    <el-form class="issueTop">
      <div class="asstopWrap">
        ...
        <div class="btnworpbox">
          ...
          <el-button size="medium" class="bluebtnclass" type="primary" @click="countSum">汇 总</el-button>
      ...
      <div class="unitList">
        <p><span>{{value}}</span>年度省直机关一类领导干部排名情况</p>
