<template>
  <div class="DividedDistricts" id="leaderganbuhyg" style="padding: 0 15px;">
    ...
    <div>
      <div class="tableboxs">
        ...
        <el-table id="banzishuju" :data="assessmentScore" border="" style="width: 100%" stripe   height="500">
          ...
          <!-- 新加 -->
          <el-table-column prop="duty" label="职务" width="150"></el-table-column>
          <el-table-column prop="people_name" label="考核对象" width="70"></el-table-column>
          <el-table-column label="年度综合考核" >
            <el-table-column prop="city_score" label="得分" width="70" ></el-table-column>
            <el-table-column prop="city_lev" label="等次" width="70" ></el-table-column>
          </el-table-column>
          <el-table-column label="民主测评">
            <el-table-column prop="overall_excellent_pct" sortable label="优秀率（%）"></el-table-column>
            <el-table-column prop="overall_good_pct" label="称职率（%）"></el-table-column>
            <el-table-column prop="overall_excell_good_pct" label="优称率（%）"></el-table-column>
            <el-table-column prop="overall_comp_pct" label="基本称职率（%）"></el-table-column>
            <el-table-column prop="overall_incomp_pct" label="不称职率（%）"></el-table-column>
            <el-table-column prop="people_score" label="测评得分"></el-table-column>
          </el-table-column>
...
export default {
  ...
  methods: {
    ...
    search() {
      ...
      this.$http
        .post(
          globalConfig.server3 + "PeopleZonghe/selectZongheByNianduAndType",
          params
        )
        .then(res => {
          if (res.data.response_code === "0") {
    ...
    countSum() {
      ...
      this.$http
        .post(globalConfig.server3 + "PeopleZonghe/updateHuizong", params)
        .then(res => {
          if (res.data.response_code === "0") {
            this.search();
            this.$message({
    ...
    saveBc() {
      this.$http
        .post(globalConfig.server3 + "PeopleZonghe/updateLev", this.changeArr)
        .then(res => {
          if (res.data.response_code === "0") {
            this.search();
            this.$message({
    ...
    scoreFormsqs() {
      ...
      this.$http
        .post(
          globalConfig.server3 + "democraticEvaluationOfShow/updateForPeople",
          params
        )
        .then(res => {
          if (res.data.response_code === "0") {
