<template>
  <div id="ProvincialAuthorities"  style="margin-top:4px;">
    <el-form class="issueTop">
      <div class="asstopWrap">
        <el-form-item label="年度：" class="assessSelect">
          <el-select v-model="value" size="mini" placeholder="请选择" class="selectWrap" @change="select()" style="width:150px">
        ...
        <el-button size="medium" type="primary" @click="search" class="bluebtnclass " > 查询</el-button>
        <div class="btnworpbox">
          <el-button size="medium" type="primary" @click="save"  class="bluebtnclass "> 保存</el-button>
        </div>
      </div>
    ...
    <div>
      <div class="tableboxs">
        <el-table :data="assessmentScore" border style="width: 100%" stripe  >
          ...
          <el-table-column prop="depName" label="考核对象">
  ...
  export default {
    ...
    methods: {
      ...
      save() {
        ...
        this.$http.post(globalConfig.server5 + 'fuwuQualityController/updateScore', this.df).then(res => {
